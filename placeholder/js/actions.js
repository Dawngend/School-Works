...
function setPlayerGender(gender)
{
  ...
  variables.gender = playerGender;
}

function resolvePronounPlaceholders(text)
{
  if(typeof text != "string" || !playerGender)
  {
    return text;
  }

  var pronounsByGender = {
    "male":{
      "he/she":"he",
      "his/her":"his",
      "him/her":"him"
  ...
  var pronouns = pronounsByGender[playerGender];
  if(!pronouns)
  {
    return text;
  }

  return text.replace(/\[(he\/she|his\/her|him\/her)\]/gi, function(match, token)
  {
    var replacement = pronouns[token.toLowerCase()];
    if(!replacement)
    {
      return match;
    }
